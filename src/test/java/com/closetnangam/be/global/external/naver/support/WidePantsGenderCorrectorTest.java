...
class WidePantsGenderCorrectorTest {
    ...
    @CsvSource({
            ...
            "MALE, BOTTOM, UNKNOWN, women wide pants, FEMALE",
            "MALE, BOTTOM, UNKNOWN, woman wide jeans, FEMALE",
            "MALE, BOTTOM, UNKNOWN, men wide pants, MALE",
            "MALE, BOTTOM, UNKNOWN, men's wide trousers, MALE"
    })
